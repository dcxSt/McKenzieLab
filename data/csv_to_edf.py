...
data = np.loadtxt('./data_15min.csv', delimiter=',').T
print("data[:,0]", data[:,0])
# print("data[0,:] ",data[0,:])
...
# now you just use the method provided from the gist

write_mne_edf(raw, fname="data_15min.edf", overwrite=True)
