...
def display_info(raw):
    print("File before loading")
    ...
    print(f"raw.times.shape {raw.times.shape}")

### Read the large .edf data file provided as parameter
raw = mne.io.read_raw_edf(f'{sys.argv[1]}')  # in my case AC75a-5 DOB 072519_TS_2020-03-23_17_30_04.edf 

display_info(raw)

# downsize sample to more managable size
N = 2000*60*30 # a 30 minute sample (the sample frequency is 2000Hz)
raw._data = raw._data[:, :N]

### Serialize data 
# this gist https://gist.github.com/skjerns/bc660ef59dca0dbd53f00ed38c42f6be
...
write_mne_edf(raw, "mouse_30min.edf", overwrite=False) 

### Open the 30 min sample
raw_small = mne.io.read_raw_edf("mouse_30min.edf", preload=True)

display_info(raw_small)
